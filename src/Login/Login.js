      ...
      <Components.SignUpContainer signinIn={signIn}>
        <Components.Form>
          ...
          <Components.HalfForm>
            ...
            <label><Components.Radio type="radio" name="gender"/>남</label>
            <label><Components.Radio type="radio" name="gender"/>여</label>
          </Components.HalfForm>
          ...
          <Components.HalfForm>
            ...
            <select value={studentId} onChange={changeStudentId}>
